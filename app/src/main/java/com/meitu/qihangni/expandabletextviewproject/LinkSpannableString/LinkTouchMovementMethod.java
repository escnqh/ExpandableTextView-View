...
import com.meitu.qihangni.expandabletextviewproject.LinkSpannableString.clickCallbaks.ClickableLinkSpan;
...
public class LinkTouchMovementMethod extends LinkMovementMethod {
    ...
    private ExpandableTextView.TouchableSpan mPressedSpan2;
    ...
    private ExpandableTextView.TouchableSpan getPressedSpan2(TextView textView, Spannable spannable, MotionEvent event) {
        ...
        ExpandableTextView.TouchableSpan[] link = spannable.getSpans(off, off, ExpandableTextView.TouchableSpan.class);
        ExpandableTextView.TouchableSpan touchedSpan = null;
        if (link.length > 0) {
            touchedSpan = link[0];
        }
        return touchedSpan;
